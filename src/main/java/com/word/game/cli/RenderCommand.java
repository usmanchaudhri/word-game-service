package com.word.game.cli;

import io.dropwizard.cli.ConfiguredCommand;
import io.dropwizard.setup.Bootstrap;

import com.google.common.base.Optional;
import com.word.game.WordGameConfiguration;
...
public class RenderCommand extends ConfiguredCommand<WordGameConfiguration> {
	...
	@Override
	protected void run(Bootstrap<WordGameConfiguration> bootstrap,
			Namespace namespace, WordGameConfiguration configuration)
			throws Exception {
